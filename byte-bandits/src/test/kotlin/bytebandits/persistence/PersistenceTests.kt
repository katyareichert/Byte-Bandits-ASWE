...
class PersistenceTests {
  ...
  fun testSimpleFilePersistFull() {
    ...
    val testSimpleFilePersist = FilePersister.simpleFilePersist(testRequest, testEndpointDirectory, testClientID, testOverwrite)

    assert(testSimpleFilePersist)

    val testSimpleFileRetrieve = FilePersister.simpleFileRetrieve(testFileName, testEndpointDirectory, testClientID, testUserID)

    assert(testSimpleFileRetrieve.contentEquals(testFileContent))

    val testSimpleFileDelete = FilePersister.simpleFileDelete(testFileName, testEndpointDirectory, testClientID, testUserID)
