...
public class FilePersister {
	...
	companion object : Persister {
		override fun simpleFilePersist(request: SimpleFileRequest, endpointDirectory: String?, clientID: String?, overwrite: Boolean): Boolean {
		...
		override fun simpleFileRetrieve(fileName: String, endpointDirectory: String?, clientID: String?, userID: String?): ByteArray {
		...
		override fun simpleFileDelete(fileName: String, endpointDirectory: String?, clientID: String?, userID: String?): Boolean {
			val path = getPath(endpointDirectory, clientID, userID, false)
